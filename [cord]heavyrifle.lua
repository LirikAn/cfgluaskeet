...
local json = require("json")
                ...
                local lua_menu = {
                    main = {
                        enable = lua_group:label("heaverifle"),
                ...
                local function screen_indicator()
                    local lp = entity.get_local_player()
                    if lp == nil then return end
                    local ind_size = renderer.measure_text("cb", "heaverifle.lua")
                    ...
                    text_fade_animation(center[1] + scoped_space, center[2] + 30, -1, {r=r1, g=g1, b=b1, a=255}, {r=r2, g=g2, b=b2, a=255}, new_check and string.upper("heaverifle.lua") or "heaverifle", main_font)
                ...
                local function info_panel()
                    ...
                    text_fade_animation(20, center[2], -1, {r=200, g=200, b=200, a=255}, {r=150, g=150, b=150, a=255}, "heaverifle.lua ~ beta", "d")
                    local textsize = renderer.measure_text("d", "heaverifle.lua ~ beta")
                ...
                local phrases = {
                    "▶• heaverifle shot you",
                    "♡ ｇａｍｅｓｅｎｓｅ ᛭ heaverifle ♡",
                    "бля хевик не выбил братик",
                    "выбил тебя как хевик",
                    "клоун играет без heaverifle.lua",
                    "♛ heaverifle owned you ♛",
                    "( ⸝⸝´꒳`⸝⸝) 𖹭 заовнил дуру с хевиком ♡",
                    "𖹭 шотнул тебя как будто с хевика на мадже 𖹭",
                    "▄︻デ══━一💨 выбито нахуй",
                    "heaverifle domination",
                    "еблан,скачай уже хевик луа",
                    "ебать ты лох, я тебя с хевика выбил",
                ...
                client.set_event_callback('paint', function()
                    ...
                    text_fade_animation(x_ind/2, y_ind-20, -1, {r=200, g=200, b=200, a=255}, {r=150, g=150, b=150, a=255}, "heaverifle", "cdb")
                end)
